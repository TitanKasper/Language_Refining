...
Mobile.tap(findTestObject('Object Repository/login cap/setting obj/android.view.ViewGroup'), 0)

Mobile.tap(findTestObject('Object Repository/login cap/setting obj/android.view.ViewGroup (1)'), 0)

Mobile.takeScreenshot('C:\\Users\\THINLA~1\\AppData\\Local\\Temp\\screenshot3283028007000970122.png')
Mobile.delay(5)
